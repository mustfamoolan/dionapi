...
class SendToMultipleRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'user_ids.required' => 'قائمة معرفات المستخدمين مطلوبة',
            'user_ids.array' => 'قائمة معرفات المستخدمين يجب أن تكون مصفوفة',
            'user_ids.min' => 'يجب تحديد مستخدم واحد على الأقل',
            'user_ids.*.required' => 'معرف المستخدم مطلوب',
            'user_ids.*.string' => 'معرف المستخدم يجب أن يكون نص',
