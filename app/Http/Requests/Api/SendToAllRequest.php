...
class SendToAllRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'filter.status' => 'nullable|string|in:pending,active,banned,expired',
    ...
    public function messages(): array
    {
        return [
            ...
            'filter.array' => 'الفلتر يجب أن يكون مصفوفة',
            'filter.status.in' => 'حالة الفلتر غير صحيحة',
            'filter.is_active.boolean' => 'قيمة is_active يجب أن تكون true أو false',
        ];
    }
}
